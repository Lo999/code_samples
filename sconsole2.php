<?php
     ...
     * To use this logger, include this file at the top:
        * include_once("/home/mesanaor/public_html/mymesa/debug/sconsole2.php")
    ...
    */
    ...
    $directory = '/home/mesanaor/public_html/mymesa/debug/';
    ...
    function slog($input_string_or_variable='breakpoint',
                  $destination="/home/mesanaor/public_html/mymesa/debug/error_slog.txt",
                  $backtrace_level=0,
                  $comment='')
    {
        //open the slog file
     ...
     */
    function slog_everything($destination="/home/mesanaor/public_html/mymesa/debug/error_slog.txt") {
     ...
     * @param string $destination //the full filepath of the slog you want to clear
     */
    function slog_wipe($destination="/home/mesanaor/public_html/mymesa/debug/error_slog.txt")
    {
